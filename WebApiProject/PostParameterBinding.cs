...
public class PostParameterBinding : HttpParameterBinding
{
    ...
    object StringToType(string stringValue)
    {
        ...
        else if (Descriptor.ParameterType == typeof(short)) value = short.Parse(stringValue, CultureInfo.CurrentCulture);
        else if (Descriptor.ParameterType == typeof(short?)) value = string.IsNullOrWhiteSpace(stringValue) ? (short?)null : short.Parse(stringValue, CultureInfo.CurrentCulture);
        else if (Descriptor.ParameterType == typeof(byte)) value = byte.Parse(stringValue, CultureInfo.CurrentCulture);
        else if (Descriptor.ParameterType == typeof(byte?)) value = string.IsNullOrWhiteSpace(stringValue) ? (byte?)null : byte.Parse(stringValue, CultureInfo.CurrentCulture);
